            ...
            <div class="wrap-login100 p-t-85 p-b-20">
                ...
                <form action="proses-daftar.php" method="post">
                    <div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate="Enter username">
                        <input class="input100" type="text" name="id_pasien" required>
                        <span class="focus-input100" data-placeholder="No Identitas (KTP/SIM/lainnya)"></span>
                    </div>
                    <div class="wrap-input100 validate-input m-b-50" data-validate="Enter username">
                        <input class="input100" type="text" name="nama_pasien" required>
                        <span class="focus-input100" data-placeholder="Nama"></span>
                    </div>
                    <div class="wrap-input100 validate-input m-b-50" data-validate="Enter username">
                        <input class="input100" type="text" name="telp" required>
